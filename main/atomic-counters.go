...
func main() {
	...
	// We’ll use an unsigned integer
	// to represent our (always-positive) counter.
	var ops uint64

	// A WaitGroup will help us wait
	...
	// It’s safe to access ops now
	// because we know no other goroutine is writing to it.
	// Reading atomics safely
	// while they are being updated is also possible,
