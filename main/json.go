...
// We’ll use these two structs
// to demonstrate encoding and decoding of custom types below.
...
// In go,
// fields and variables that start with an Uppercase letter are "Exported",
// and are visible to other packages.
// Fields that start with a lowercase letter are "unexported",
// and are only visible inside their own package.
// Ref: https://stackoverflow.com/a/40256210
...
func main() {
	...
	// We need to provide a variable
	// where the JSON package can put the decoded data.
	...
	// we always used bytes and strings
